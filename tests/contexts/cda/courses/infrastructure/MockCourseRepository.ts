import { Course } from "../../../../../src/contexts/cda/courses/domain/Course";
import { CourseId } from "../../../../../src/contexts/cda/courses/domain/CourseId";
import { CourseRepository } from "../../../../../src/contexts/cda/courses/domain/CourseRepository";
...
export class MockCourseRepository implements CourseRepository {
	...
	shouldSearch(course: Course | null): void {
