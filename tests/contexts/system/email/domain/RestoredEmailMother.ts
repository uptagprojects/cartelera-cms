import {
	RestoredEmail
} from "../../../../../src/contexts/system/email/domain/RestoredEmail";
...
export class RestoredEmailMother {
	static create(params?: Partial<BlockedEmailPrimitives>): RestoredEmail {
		...
		return RestoredEmail.fromPrimitives(primitives);
	}
}
