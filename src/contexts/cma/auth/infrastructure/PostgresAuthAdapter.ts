...
export default function postgresAdapter(connection: PostgresConnection, uuidGenerator: UuidGenerator): Adapter {
    ...
    return {
        ...
        async getUserByAccount({
            ...
            const account = await authAccountRepository.searchByProvider(provider, providerAccountId);
        ...
        async linkAccount(account: AdapterAccount): Promise<void | undefined | null | AdapterAccount> {
        ...
        async unlinkAccount({ provider, providerAccountId }: Partial<AdapterAccount>): Promise<void> {
            const account = await authAccountRepository.searchByProvider(provider as string, providerAccountId as string);
            if(account) {
