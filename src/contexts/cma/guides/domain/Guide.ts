...
import { GuideArchivedDomainEvent } from "./events/GuideArchivedDomainEvent";
import { GuideContentUpdatedDomainEvent } from "./events/GuideContentUpdatedDomainEvent";
import { GuidePostedDomainEvent } from "./events/GuidePostedDomainEvent";
import { GuidePublishedDomainEvent } from "./events/GuidePublishedDomainEvent";
import { GuideRestoredDomainEvent } from "./events/GuideRestoredDomainEvent";
import { GuideTitleUpdatedDomainEvent } from "./events/GuideTitleUpdatedDomainEvent";
...
export class Guide extends AggregateRoot {
    ...
    static create(id: string, title: string, content: string, ucId: string, authorId: string): Guide {
        ...
        guide.record(new GuidePostedDomainEvent(id, title, content, ucId, authorId, defaultGuideStatus));
