...
import { UserArchivedDomainEvent } from "./events/UserArchivedDomainEvent";
import { UserAvatarUpdatedDomainEvent } from "./events/UserAvatarUpdatedDomainEvent";
import { UserBlockedDomainEvent } from "./events/UserBlockedDomainEvent";
import { UserConfirmedDomainEvent } from "./events/UserConfirmedDomainEvent";
...
import { UserRestoredDomainEvent } from "./events/UserRestoredDomainEvent";
...
export class User extends AggregateRoot {
    ...
    confirm(name?: string, avatar?: string): void {
        ...
        this.record(new UserConfirmedDomainEvent(this.id.value, this.name.value, this.avatar.value.toString()));
    }
