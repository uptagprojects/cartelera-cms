...
export class UserArchivedEmailSentDomainEvent extends DomainEvent {
    static eventName = "pnfi.system.user_archived_email.sent";
    constructor(
        ...
        super(UserArchivedEmailSentDomainEvent.eventName, id, eventId, occurredOn);
    }
    ...
    ): UserArchivedEmailSentDomainEvent {
        return new UserArchivedEmailSentDomainEvent(
            aggregateId,
