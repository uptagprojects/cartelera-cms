...
import { Avatar, Button, Card, CardFooter, CardHeader, Container, Spinner, Tag } from "octagon-ui";
            ...
            <Card>
                ...
                <CardFooter>
                    <div className={styles.recentGuidesFooter}>
                        ...
                        <div>
                            <p className={styles.recentGuidesAuthor}>{professor.name}</p>
...
export const GuideList = () => {
    ...
    return (
        <>
            ...
            <div>
                {guides.map(guide => (
                    <GuideListItem key={guide.id} {...guide} />
                ))}
            </div>
            <Container align="center">
                {loading && <Spinner />}
